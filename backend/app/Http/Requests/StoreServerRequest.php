...
class StoreServerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'java_ip' => ['required', 'string', 'max:255'],
            ...
            'logo' => ['nullable', 'image', 'mimes:png,jpeg,webp', 'max:2048', 'dimensions:min_width=128,min_height=128'],
            'banner_card' => ['nullable', 'file', 'mimes:mp4,webp,jpeg,png', 'max:5120'],
            'banner_detail' => ['nullable', 'file', 'mimes:mp4,webp,jpeg,png', 'max:15360'],
